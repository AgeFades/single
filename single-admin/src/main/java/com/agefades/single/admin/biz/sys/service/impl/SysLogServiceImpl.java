...
import com.agefades.single.admin.biz.sys.mapper.SysLogMapper;
...
public class SysLogServiceImpl extends ServiceImpl<SysLogMapper, SysLog> implements SysLogService {
    ...
    public void saveLog(ProceedingJoinPoint point, String errorMsg, long elapsedTime, HttpServletRequest request, String ip, String username) {
        ...
        com.agefades.single.admin.annotation.SysLog sysLogAnnotation = method.getAnnotation(com.agefades.single.admin.annotation.SysLog.class);
