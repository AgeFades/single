package com.agefades.single.admin.util;
...
public class SysThreadLocalUtil extends ThreadLocalUtil {
    ...
    public static void setCurUser(SysUserDTO dto) {
        log.info("当前操作用户: {}", JSONUtil.toJsonStr(dto));
    ...
    public static SysUserDTO getCurUser() throws RuntimeException {
        ...
        Assert.isTrue(ObjectUtil.isNotNull(dto), CommonResultCodeEnum.TOKEN_PARSE_ERROR);
        return dto;
    }
    ...
    public static Boolean isAdmin() {
        return getCurUser().getIsAdmin() == BoolEnum.Y.getCode();
    }
